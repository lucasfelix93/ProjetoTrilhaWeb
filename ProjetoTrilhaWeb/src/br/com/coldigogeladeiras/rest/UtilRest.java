...
public class UtilRest {
	...
	public Response buildResponse(Object result) {
			...
			try {
				/*
				 * Retorna o o objeto de resposta com status 200 (ok), tendo em
				 * seu corpo o objeto valorResposta (que consiste no
	 ...
	 * não realizadas com sucesso, ou seja, que contenham algum erro.
	 * Repare que o método em questão aguarda que seja repassado um
	...
	public Response buildErrorResponse(String str) {
		 ...
		 * mensagem que será retornada para o cliente.
		 */
		rb = rb.entity(str);
